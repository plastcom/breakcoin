...
{
    resize(850, 550);
    setWindowTitle(tr("BreakCoin") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&BreakCoin Masternodes"), this);
    masternodeManagerAction->setToolTip(tr("Show BreakCoin Masternode Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About BreakCoin"), this);
    aboutAction->setToolTip(tr("Show information about BreakCoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BreakCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BreakCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BreakCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BreakCoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BRE address or malformed URI parameters."));
    }
...
void BitcoinGUI::handleURI(QString strURI)
{
    ...
    if (sendCoinsPage->handleURI(strURI))
    {
        ...
        notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BreakCoin address or malformed URI parameters."));
}
